    ...
    <div class="container">
        <div class="row mt-5">
            <?php
               ...
               $id =$_POST['id'];
               $UpdateSQL="Update estudiantes set nombres ='$nombres', apellidos='$apellidos',fechanac='$fechanac', curso='$curso', carrera='$carrera', jornada='$jornada' where id = $id";
               ...
               if($conexion->query($UpdateSQL) === true){
                 ...
                 <p>
                     Los datos han sido actualizados, puede consultar la información de '.$nombres.' '.$apellidos.' en la lista.
                     <center> <h1> <i class="fas fa-hdd"></i></h1></center>
                     </p>
